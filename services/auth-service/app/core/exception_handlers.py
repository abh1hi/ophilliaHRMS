"""
Generic FastAPI exception handlers for the auth-service.
...
# ---------------------------------------------------------------------------
# HTTP status → semantic error code mapping
# ---------------------------------------------------------------------------
...
async def http_exception_handler(request: Request, exc: StarletteHTTPException) -> JSONResponse:
    ...
    # Preserve detail string but never expose raw Python exceptions
...
async def validation_exception_handler(
    ...
    # Collect the first error per field into a readable summary
    errors = exc.errors()
    field_messages = []
    for err in errors:
